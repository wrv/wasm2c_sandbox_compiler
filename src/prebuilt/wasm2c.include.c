...
"  static inline t3 name(wasm_rt_memory_t* mem, u64 addr, const char* func_name) {   \\\n"
"    MEMCHECK(mem, addr, t1);                                                        \\\n"
"    t1 result = _mm_loadu_si128((__m128i*) MEM_ACCESS_REF(mem, addr));              \\\n"
"    WASM2C_SHADOW_MEMORY_LOAD(mem, func_name, addr, sizeof(t1));                    \\\n"
"    return (t3)(t2)result;                                                          \\\n"
"  }\n"
"\n"
...
"    MEMCHECK(mem, addr, t1);                                                                  \\\n"
"    t1 wrapped = (t1)value;                                                                   \\\n"
"    _mm_storeu_si128((__m128i*) MEM_ACCESS_REF(mem, addr), wrapped);                          \\\n"
"    WASM2C_SHADOW_MEMORY_STORE(mem, func_name, addr, sizeof(t1));                             \\\n"
"  }\n"
"\n"
"DEFINE_SIMD_LOAD(v128_load, __m128i, __m128i, __m128i);\n"
"DEFINE_SIMD_STORE(v128_store, __m128i, __m128i); \n"
"\n"
"\n"
"static inline __m128i v128_load8_splat(u8 v1) {\n"
"  return  _mm_set1_epi8(v1);\n"
"}\n"
"\n"
"static inline __m128i v128_load16_splat(u16 v1) {\n"
"  return  _mm_set1_epi16(v1);\n"
"}\n"
"\n"
"static inline __m128i v128_load32_splat(u32 v1) {\n"
"  return  _mm_set1_epi32(v1);\n"
"}\n"
"\n"
"static inline __m128i v128_load64_splat(u64 v1) {\n"
"  return  _mm_set1_epi64x(v1);\n"
"}\n"
"\n"
"/* I32X4 AVX Operations */\n"
"static inline __m128i I32X4_ABS(__m128i v1) {\n"
"  return  _mm_abs_epi32(v1);\n"
"}\n"
"\n"
"static inline __m128i I32X4_ADD(__m128i v1, __m128i v2) {\n"
"  return  _mm_add_epi32(v1, v2);\n"
"}\n"
"\n"
"//static inline int I32X4_ALLTRUE(__m128i v1) {\n"
"//  // v1 AND 0xFFF..FFF then tested for all_zeros\n"
"//  //return _mm_and_si128(v1, _mm_set1_epi32(-1));\n"
"//}\n"
"\n"
"static inline int I32X4_BITMASK(__m128i v1) {\n"
"  return _mm_movemask_ps((__m128) v1);\n"
"}\n"
"\n"
"static inline __m128i I32X4_DOTI16X8S(__m128i v1, __m128i v2) {\n"
"  return _mm_madd_epi16(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_EXTADD_PAIRWISE_I16X8_S(__m128i v1) {\n"
"  return _mm_madd_epi16(v1, v1); \n"
"}\n"
"\n"
"static inline __m128i I32X4_EQ(__m128i v1, __m128i v2) {\n"
"  return  _mm_cmpeq_epi32(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_GE_S(__m128i v1, __m128i v2) {\n"
"  return (__m128i) _mm_cmpge_ps((__m128)v1, (__m128)v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_GT_S(__m128i v1, __m128i v2) {\n"
"  return  _mm_cmpgt_epi32(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_LE_S(__m128i v1, __m128i v2) {\n"
"  return (__m128i) _mm_cmple_ps((__m128)v1, (__m128)v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_LT_S(__m128i v1, __m128i v2) {\n"
"  return  _mm_cmplt_epi32(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_MAX_S(__m128i v1, __m128i v2) {\n"
"  return _mm_max_epi32(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_MIN_S(__m128i v1, __m128i v2) {\n"
"  return _mm_min_epi32(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_MUL(__m128i v1, __m128i v2) {\n"
"  return _mm_mullo_epi32(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_NE(__m128i v1, __m128i v2) {\n"
"  return (__m128i) _mm_cmpneq_ps((__m128) v1, (__m128) v2);\n"
"}\n"
"\n"
"static inline __m128i I32X4_NEG(__m128i v1) {\n"
"  return _mm_sub_epi32(_mm_set1_epi32(0.0),v1);\n"
"}\n"
"\n"
"static inline __m128i I32X4_SHL(__m128i v1, int imm8) {\n"
"  return _mm_slli_epi32(v1, imm8);\n"
"}\n"
"\n"
"static inline __m128i I32X4_SHR_S(__m128i v1, int imm8) {\n"
"  return _mm_srai_epi32(v1, imm8);\n"
"}\n"
"\n"
"static inline __m128i I32X4_SPLAT(float v1) {\n"
"  return _mm_set1_epi32(v1);\n"
"}\n"
"\n"
"static inline __m128i I32X4_SUB(__m128i v1, __m128i v2) {\n"
...
"\n"
"/* V128 AVX Operations */\n"
"static inline __m128i V128_AND(__m128i v1, __m128i v2) {\n"
"  return  _mm_and_si128(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i V128_ANDNOT(__m128i v1, __m128i v2) {\n"
"  return  _mm_andnot_si128(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i V128_OR(__m128i v1, __m128i v2) {\n"
"  return  _mm_or_si128(v1, v2);\n"
"}\n"
"\n"
"static inline __m128i V128_NOT(__m128i v1) {\n"
"  return  _mm_xor_si128(v1, _mm_set1_epi32(-1));\n"
"}\n"
"\n"
"static inline __m128i V128_XOR(__m128i v1, __m128i v2) {\n"
"  return  _mm_xor_si128(v1, v2);\n"
"}\n"
"\n"
"\n"
"static inline __m128i V128_BITSELECT(__m128i v1, __m128i v2, __m128i mask) {\n"
"  return V128_OR(V128_AND(v1, mask), V128_AND(v2, V128_NOT(mask)));\n"
"  //return  _mm_blendv_epi8(v1, v2, mask); // Unfortunately blendv doesn't work at bit-granularity\n"
"}\n"
"\n"
"\n"
"// </AVX_SIMD>\n"
