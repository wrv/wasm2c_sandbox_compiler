...
"\n"
"// <AVX_SIMD>\n"
"// TODO: specify different SIMD libraries: x86 SSE and AVX or ARM NEON\n"
"\n"
"#define DEFINE_SIMD_LOAD(name, t1, t2, t3)                                          \\\n"
"  static inline t3 name(wasm_rt_memory_t* mem, u64 addr, const char* func_name) {   \\\n"
"    MEMCHECK(mem, addr, t1);                                                        \\\n"
"    t1 result = simde_wasm_v128_load((simde_v128_t*) MEM_ACCESS_REF(mem, addr));              \\\n"
"    WASM2C_SHADOW_MEMORY_LOAD(mem, func_name, addr, sizeof(t1));                    \\\n"
"    return (t3)(t2)result;                                                          \\\n"
"  }\n"
"\n"
...
"  static inline t3 name(wasm_rt_memory_t* mem, u64 addr, const char* func_name) {   \\\n"
"    MEMCHECK(mem, addr, t1);                                                        \\\n"
"    t1 result = func ((simde_v128_t*) MEM_ACCESS_REF(mem, addr));              \\\n"
"    WASM2C_SHADOW_MEMORY_LOAD(mem, func_name, addr, sizeof(t1));                    \\\n"
"    return (t3)(t2)result;                                                          \\\n"
"  }\n"
"\n"
"#define DEFINE_SIMD_LOAD_LANE(name, func, t1, t2, t3, lane)                                          \\\n"
"  static inline t3 name(wasm_rt_memory_t* mem, u64 addr, t1 vec, const char* func_name) { \\\n"
"    MEMCHECK(mem, addr, t1);                                                        \\\n"
"    t1 result = func ((simde_v128_t*) MEM_ACCESS_REF(mem, addr), vec, lane);        \\\n"
"    WASM2C_SHADOW_MEMORY_LOAD(mem, func_name, addr, sizeof(t1));                    \\\n"
"    return (t3)(t2)result;                                                          \\\n"
"  }\n"
"\n"
...
"    MEMCHECK(mem, addr, t1);                                                                  \\\n"
"    t1 wrapped = (t1)value;                                                                   \\\n"
"    simde_wasm_v128_store((simde_v128_t*) MEM_ACCESS_REF(mem, addr), wrapped);                          \\\n"
"    WASM2C_SHADOW_MEMORY_STORE(mem, func_name, addr, sizeof(t1));                             \\\n"
"  }\n"
"\n"
...
"    MEMCHECK(mem, addr, t1);                                                                  \\\n"
"    t1 wrapped = (t1)value;                                                                   \\\n"
"    func ((simde_v128_t*) MEM_ACCESS_REF(mem, addr), wrapped, lane);                          \\\n"
"    WASM2C_SHADOW_MEMORY_STORE(mem, func_name, addr, sizeof(t1));                             \\\n"
"  }\n"
"\n"
...
"\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane0, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 0);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane1, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 1);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane2, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 2);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane3, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 3);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane4, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 4);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane5, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 5);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane6, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 6);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane7, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 7);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane8, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 8);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane9, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 9);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane10, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 10);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane11, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 11);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane12, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 12);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane13, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 13);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane14, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 14);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane15, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, 15);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load16_lane0, simde_wasm_v128_load16_lane, simde_v128_t, simde_v128_t, 0);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load16_lane1, simde_wasm_v128_load16_lane, simde_v128_t, simde_v128_t, 1);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load16_lane2, simde_wasm_v128_load16_lane, simde_v128_t, simde_v128_t, 2);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load16_lane3, simde_wasm_v128_load16_lane, simde_v128_t, simde_v128_t, 3);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load16_lane4, simde_wasm_v128_load16_lane, simde_v128_t, simde_v128_t, 4);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load16_lane5, simde_wasm_v128_load16_lane, simde_v128_t, simde_v128_t, 5);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load16_lane6, simde_wasm_v128_load16_lane, simde_v128_t, simde_v128_t, 6);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load16_lane7, simde_wasm_v128_load16_lane, simde_v128_t, simde_v128_t, 7);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load32_lane0, simde_wasm_v128_load32_lane, simde_v128_t, simde_v128_t, 0);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load32_lane1, simde_wasm_v128_load32_lane, simde_v128_t, simde_v128_t, 1);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load32_lane2, simde_wasm_v128_load32_lane, simde_v128_t, simde_v128_t, 2);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load32_lane3, simde_wasm_v128_load32_lane, simde_v128_t, simde_v128_t, 3);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load64_lane0, simde_wasm_v128_load64_lane, simde_v128_t, simde_v128_t, 0);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load64_lane1, simde_wasm_v128_load64_lane, simde_v128_t, simde_v128_t, 1);\n"
"\n"
"\n"
"\n"
