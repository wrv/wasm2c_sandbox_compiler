...
"  }\n"
"\n"
"#define DEFINE_SIMD_LOAD_LANE(name, func, t1, t2, t3)                                          \\\n"
"  static inline t3 name(wasm_rt_memory_t* mem, u64 addr, t1 vec, const s32 lane, const char* func_name) {   \\\n"
"    MEMCHECK(mem, addr, t1);                                                        \\\n"
...
"  }\n"
"\n"
"#define DEFINE_SIMD_STORE_LANE(name, func, t1, t2)                                                       \\\n"
"  static inline void name(wasm_rt_memory_t* mem, u64 addr, t2 value, const s32 lane, const char* func_name) { \\\n"
"    MEMCHECK(mem, addr, t1);                                                                  \\\n"
"    t1 wrapped = (t1)value;                                                                   \\\n"
...
"\n"
"DEFINE_SIMD_LOAD_LANE(v128_load8_lane, simde_wasm_v128_load8_lane, simde_v128_t, simde_v128_t, simde_v128_t);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load16_lane, simde_wasm_v128_load16_lane, simde_v128_t, simde_v128_t, simde_v128_t);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load32_lane, simde_wasm_v128_load32_lane, simde_v128_t, simde_v128_t, simde_v128_t);\n"
"DEFINE_SIMD_LOAD_LANE(v128_load64_lane, simde_wasm_v128_load64_lane, simde_v128_t, simde_v128_t, simde_v128_t);\n"
"\n"
"DEFINE_SIMD_STORE(v128_store, simde_v128_t, simde_v128_t); \n"
"DEFINE_SIMD_STORE_LANE(v128_store8_lane, simde_wasm_v128_store8_lane, simde_v128_t, simde_v128_t); \n"
"DEFINE_SIMD_STORE_LANE(v128_store16_lane, simde_wasm_v128_store16_lane, simde_v128_t, simde_v128_t); \n"
"DEFINE_SIMD_STORE_LANE(v128_store32_lane, simde_wasm_v128_store32_lane, simde_v128_t, simde_v128_t); \n"
"DEFINE_SIMD_STORE_LANE(v128_store64_lane, simde_wasm_v128_store64_lane, simde_v128_t, simde_v128_t); \n"
"\n"
"\n"
"#if defined(_MSC_VER)\n"
"#include <intrin.h>\n"
